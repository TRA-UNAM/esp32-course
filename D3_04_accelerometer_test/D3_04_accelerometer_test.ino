/*  Sketch modified to work with the accelerometer in the mobile robot
 *   ESP32 TRA course
 *   
...
const byte xpin = 32;                  // x-axis of the accelerometer on pin 32 (mobile robot)
const byte ypin = 33;                  // y-axis of the accelerometer on pin 33 (mobile robot)
const byte zpin = 25;                  // z-axis (only on 3-axis models) on pin 25 (mobile robot)
